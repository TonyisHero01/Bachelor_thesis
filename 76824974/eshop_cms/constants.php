...
define("PRODUCT_PARAM_TITLES", ["{{NAME_TITLE}}", "{{ADD_TIME_TITLE}}", "{{KATEGORY_TITLE}}", "{{DESCRIPTION_TITLE}}", "{{NUMBER_IN_STOCK_TITLE}}", "{{IMAGE_TITLE}}", "{{WIDTH_TITLE}}", "{{HEIGHT_TITLE}}", "{{LENGTH_TITLE}}", "{{WEIGHT_TITLE}}", "{{MATERIAL_TITLE}}", "{{COLOR_TITLE}}", "{{PRICE_TITLE}}"]);
define("BUTTON_CONTENT_TITLES_IN_PRODUCT_EDIT", ["{{SAVE_BUTTON_TITLE}}", "{{BACK_TO_PRODUCTS_TITLE}}"]);
define("PRODUCT_LIST_TITLES", ["{{PRODUCT_LIST_TITLE}}", "{{EDIT_BUTTON_TITLE}}", "{{DELETE_BUTTON_TITLE}}", "{{CREATE_PRODUCT_BUTTON_TITLE}}", "{{CREATE_BUTTON_TITLE}}", "{{CANCEL_BUTTON_TITLE}}", "{{NEXT_BUTTON_TITLE}}", "{{PREVIOUS_BUTTON_TITLE}}"]);