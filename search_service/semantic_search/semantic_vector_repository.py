...
class SemanticVectorRepository:
    ...
    def get_products_for_indexing(self):
        ...
        return [
            self.row_to_product_dict(row)
            for row in rows
        ]
    
    def get_product_for_indexing_by_sku(self, sku: str):
        ...
        return self.row_to_product_dict(row)
    ...
    def delete_embedding_by_product_id(self, product_id: int):
        sql = """
    ...
    def delete_embedding_by_sku(self, sku: str):
        sku = str(sku or "").strip()
        ...
        sql = """
            DELETE FROM product_semantic_vector v
            USING product p
