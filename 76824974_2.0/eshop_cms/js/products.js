...
async function create() {
    ...
    try {
        ...
        console.log("ID:", id);
        window.location.href = constants.APP_DIRECTORY + "product-edit/" + id + "/" +LANGUAGE_Element;
    } catch (error) {
...
function edit(id) {
    ...
    window.location.href = constants.APP_DIRECTORY + "product-edit/" + id + "/" + "en";
}
function delete_(id) {
