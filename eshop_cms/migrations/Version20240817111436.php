...
final class Version20240817111436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX IF NOT EXISTS UNIQ_5D9F75A1E7769B0F ON Employee (surname)');
        $this->addSql('CREATE UNIQUE INDEX IF NOT EXISTS UNIQ_5D9F75A15E237E06 ON Employee (name)');
